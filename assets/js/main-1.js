...
var swiper = new Swiper('.sb-first-container', {
  autoplay: {
      delay: 3500,
      disableOnInteraction: false,
  },
  navigation: {
    nextEl: '.sb-first-right',
    prevEl: '.sb-first-left',
  },
});

var swiper = new Swiper('.sb-second-container', {
  autoplay: {
      delay: 3500,
      disableOnInteraction: false,
  },
  navigation: {
    nextEl: '.sb-second-right',
    prevEl: '.sb-second-left',
  },
});

var swiper = new Swiper('.opportunities-area-slide', {
    slidesPerView: 4,
    spaceBetween: 10,
    navigation: {
      nextEl: '.opportunities-area-arrow-right',
      prevEl: '.opportunities-area-arrow-left',
    },
    observer: true,
    observeParents: true,
    breakpoints: {
...
var swiper = new Swiper('.brands-area-content', {
    slidesPerView: 8,
    spaceBetween: 10,
    navigation: {
      nextEl: '.brands-area-arrow-right',
      prevEl: '.brands-area-arrow-left',
    },
    observer: true,
    observeParents: true,
    breakpoints: {
...
var swiper = new Swiper('.hp-popular-products', {
    slidesPerView: 5,
    spaceBetween: 10,
    navigation: {
      nextEl: '.hp-popular-area-arrow-right',
      prevEl: '.hp-popular-area-arrow-left',
    },
    observer: true,
    observeParents: true,
    breakpoints: {
...
var swiper = new Swiper('.hp-campaigns-products', {
    slidesPerView: 5,
    spaceBetween: 10,
    navigation: {
      nextEl: '.hp-campaigns-area-arrow-right',
      prevEl: '.hp-campaigns-area-arrow-left',
    },
    observer: true,
    observeParents: true,
    breakpoints: {
...
var swiper = new Swiper('.hp-attention-products', {
    slidesPerView: 5,
    spaceBetween: 10,
    navigation: {
      nextEl: '.hp-attention-area-arrow-right',
      prevEl: '.hp-attention-area-arrow-left',
    },
    observer: true,
    observeParents: true,
    breakpoints: {
...
var swiper = new Swiper('.hp-best-seller-products', {
    slidesPerView: 5,
    spaceBetween: 10,
    navigation: {
      nextEl: '.hp-best-seller-area-arrow-right',
      prevEl: '.hp-best-seller-area-arrow-left',
    },
    observer: true,
    observeParents: true,
    breakpoints: {
...
var swiper = new Swiper('.similar-products-content', {
    slidesPerView: 4,
    spaceBetween: 10,
    navigation: {
      nextEl: '.similar-products-arrow-right',
      prevEl: '.similar-products-arrow-left',
    },
    observer: true,
    observeParents: true,
    breakpoints: {
...
var swiper = new Swiper('.plist-banner-container', {
  pagination: {
    el: '.swiper-pagination',
        clickable: true,
  },
...
var swiper = new Swiper('.plist-banner-campaign-slide', {
  slidesPerView: 1,
  spaceBetween: 10,
  navigation: {
    nextEl: '.plist-banner-arrow-right',
    prevEl: '.plist-banner-arrow-left',
  },
  observer: true,
  observeParents: true,
}); 
...
$(".products-filter-box-header").click(function() {
  var display = $(this).closest('.products-filter-box').find(".products-filter-box-content").is(":visible") ? 1 : 0;
  if(display == 1) {
    $(this).closest('.products-filter-box').find(".products-filter-box-content").slideUp();
    $(this).children("button").children("svg").html('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-up"><path d="M18 15l-6-6-6 6"/></svg>')
  } else {
    $(this).closest('.products-filter-box').find(".products-filter-box-content").slideDown();
    $(this).children("button").children("svg").html('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><path d="M6 9l6 6 6-6"/></svg>')
  }
})


var swiper = new Swiper('.pd-campaign-products-content', {
  slidesPerView: 4,
  spaceBetween: 10,
  navigation: {
    nextEl: '.pd-campaign-arrow-right',
    prevEl: '.pd-campaign-arrow-left',
  },
  observer: true,
  observeParents: true,
}); 

var swiper = new Swiper('.related-products-content', {
  slidesPerView: 4,
  spaceBetween: 10,
  navigation: {
    nextEl: '.related-products-arrow-right',
    prevEl: '.related-products-arrow-left',
  },
  observer: true,
  observeParents: true,
  breakpoints: {
...
var swiper = new Swiper('.basket-c-one', {
  slidesPerView: 3,
  spaceBetween: 10,
  navigation: {
    nextEl: '.basket-c-arrow-one-right',
    prevEl: '.basket-c-arrow-one-left',
  },
  observer: true,
  observeParents: true,
  breakpoints: {
...
var swiper = new Swiper('.basket-c-sec', {
  slidesPerView: 3,
  spaceBetween: 10,
  navigation: {
    nextEl: '.basket-c-arrow-sec-right',
    prevEl: '.basket-c-arrow-sec-left',
  },
  observer: true,
  observeParents: true,
  breakpoints: {
...
// Product Comment Main Rate Star
$(".pr-rate-star").rateYo({
  starWidth: "30px",
  normalFill: "#e0e0e0",
  fullStar: true,
...
// Product Comment User Comment Rate Star
$(".product-comments-rate-star").rateYo({
  starWidth: "20px",
  normalFill: "#e0e0e0",
  fullStar: true,
});

// Product Comment Modal Rate Star
$(".product-comment-modal-rate-star").rateYo({
  starWidth: "30px",
  normalFill: "#e0e0e0",
  fullStar: true,
});

// Product Comment Rate Main bar

(function projectStatus() {
  const percent = document.querySelectorAll('.product-rate-bar[data-percent]');
  const bars = document.querySelectorAll('.product-rate-bar');
  if (percent && bars) {
...
$(".product-box-fav button").click(function () {
  ...
  $.fn.piece = function () {
    this.each(function () {
      ...
      if(!el.parent('.piece').find('.piece-button').length){
        el.before('<div class="piece-button sub flex items-center justify-center" data-type="down"><svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="5" y1="12" x2="19" y2="12"></line></svg></div>');
        el.after('<div class="piece-button add flex items-center justify-center" data-type="up"><svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></div>');
...
const galleryThumbs = new Swiper('.product-detail-image-thumb', {
  slidesPerView: 4,
  spaceBetween: 10,
  freeMode: false,
...
const galleryTop = new Swiper('.product-detail-image-main', {
  spaceBetween: 10,
  navigation: {
...
modal('.payment-notification-btn', '.modal-close');
modal('.send-comment-btn', '.modal-close');
modal('.send-alarm-btn', '.modal-close');
modal('.p-stock-alarm-btn', '.modal-close');
modal('.send-question-btn', '.modal-close');
modal('.extradition-request-btn', '.modal-close');
modal('.extradition-detail-btn', '.modal-close');
modal('.ticket-detail-btn', '.modal-close');
modal('.new-ticket-btn', '.modal-close');
modal('.comparison-button', '.modal-close');
...
var lastTotalPrice = $("#totalPrice").text();
var feeTotal = $(".summary-shipping p").data("total");
var orjSub = $(".summary-shipping p").data("sub");
var transSub = $(".summary-shipping p").data("tf");
var transTax = $(".summary-shipping p").data("ttax");
var orjTax = $(".summary-shipping p").data("orjtax");
$(".pay-checkbox label input").click(function() {
  var e = $(this).is(":checked") ? 1 : 0;
  $(".checkbox label input").prop("checked", !1), e && ($(".pay-process-content").slideUp(), $(this).parents("a").next(".pay-process-content").slideDown())
  var parent = $(this).closest('li');
  parent.find(".bank:first").prop('checked',true)
  
  var type = $(this).data("type");
  if(type == 2){
  	$("#subTotalPrice").text(transSub);
  	$(".summary-shipping").removeClass('hidden');
  	$("#totalPrice").text(feeTotal)
  	$("#taxPrice").text(transTax);

  }else {
  	$("#subTotalPrice").text(orjSub);
  	$("#taxPrice").text(orjTax);
  	$(".summary-shipping").addClass('hidden')
  	$("#totalPrice").text(lastTotalPrice)
...
$('.extradition-list-head').click(function() {
  const display = $(this).next().is(':visible') ? 1 : 0;
  $('.extradition-list-content').hide();
  $('.extradition-list-head button').css("transform", "rotate(0deg)");
  if (display) {
      $(this).next().hide();
      $(this).children("button").css("transform", "rotate(0deg)");
  } else {
...
function scrollPosition() {
  ...
  const element = document.querySelector('.go-up');
...
$(".p-list-filter-btn").click(function() {
    ...
    $(".product-filter-content").css("left", "0"), $("body").css({
    width: "100%",
    overflow: "hidden",
    position: "fixed"
  })
...
$(".product-filter-head button").click(function() {
  ...
  $(".product-filter-content").css("left", "-999px"), $("body").css({
    width: "auto",
    "overflow-y": "auto",
    position: "initial"
  })
...
$(document).click(function(e) {
  const target = e.target;
  if (!$(target).is('.product-filter-content, .product-filter-content *, .p-list-filter-btn, .p-list-filter-btn *')) {
      $('.product-filter-area').fadeOut(),
...
$(".add-promotion button").click(function() {
  ($(".coupon-form").is(":visible") ? 1 : 0) ? ($(".add-promotion button").children("svg").css("transform","rotate(0deg)"),$(".coupon-form").slideUp()) : ($(".add-promotion button").children("svg").css("transform","rotate(180deg)"), $(".coupon-form").slideDown())
});
...
if($(window).width() <= 640) {
  ...
  $(".basket-box-summary span").click(function() {
    ($(".basket-box-summary ul").is(":visible") ? 1 : 0) ? ($(".basket-box-summary span").children("svg").css("transform","rotate(180deg)"),$(".basket-box-summary ul").slideUp()) : ($(".basket-box-summary span").children("svg").css("transform","rotate(0deg)"), $(".basket-box-summary ul").slideDown())
  });

}
$(".mobile-nav-btn").click(function() {
  $(".mobile-menu-area").fadeIn(), 
  $(".mobile-menu-content").css("left", "0"), $("body").css({
  width: "100%",
  overflow: "hidden",
  position: "fixed"
})
...
$(".mobile-menu-content").css("left", "-999px"), $("body").css({
  width: "auto",
  "overflow-y": "auto",
  position: "initial"
})
...
$(".mobile-menu-back button").click(function() {
  $(".menu-sub-categories").fadeOut(),
  $(".menu-main-categories").fadeIn(),
  $(".mobile-menu-back").css("display", "none")
});

$(document).click(function(e) {
const target = e.target;
if (!$(target).is('.mobile-menu-content, .mobile-menu-content *, .mobile-nav-btn, .mobile-nav-btn *')) {
    $('.mobile-menu-area').fadeOut(),
    $(".mobile-menu-content").css("left", "-999px"),
    $("body").css({
        "width": "auto",
        "overflow-y": "auto",
        "position": "initial",
...
function scrollSearch() {
  const scrollSearch = scrollY;
  const scrollTotal = 65;
  if (typeof scrollSearch === 'number' && scrollSearch >= scrollTotal) {
...
if(window.screen.width <= 1024) {
  document.addEventListener('scroll', scrollSearch);
}

$(document).click(function(e) {
  const target = e.target;
  if (!$(target).is('.search, .search *, .main-search-suggest, .main-search-suggest *, .main-search-suggest-box, .main-search-suggest-box *, .suggest-close, .suggest-close *')) {
    $(".main-search-suggest").hide();
    $(".main-search-suggest").html("");
    $(".search-input input").val("");
  }
});

function smoothScrollDesc(eID) {
